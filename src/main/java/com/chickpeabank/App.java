...
public class App {
    ...
    ChickpeaDomainService bankDomainService = new ChickpeaDomainService();
    ...
    public void assignAccountToTheClient() throws RepeatedValuesException {
        System.out.println("-----------Enter your detail-----------\n");
        System.out.println("Enter your Id");
        String id = read.next();
        System.out.println("Enter the account number");
    ...
    //problems  here
    public void transfer() throws NegativeValuesException, InvalidValuesException, InsufficientValuesException, RepeatedValuesException, OutRangeValuesException {//               //metodo que busque cuentas por medio de numero de cuentas, paratros 1 numero de cuenta, hacer en el banco con pruebas
    ...
    public void printClientDetail() throws RepeatedValuesException {
    ...
    public static void main(String[] args) throws RepeatedValuesException, InvalidValuesException, NegativeValuesException, OutRangeValuesException, InsufficientValuesException, OnlyStringException {
        App appBank = new App();
        int option;
        boolean exist = false;
        Scanner read = new Scanner(System.in);
